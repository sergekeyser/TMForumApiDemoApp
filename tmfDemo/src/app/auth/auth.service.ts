...
export class AuthService extends IonicAuth {
  ...
  private addConfig() {
    const clientId = '0oa1i93yqkobstk3h357';
    const issuer = 'https://dev-602142.okta.com/oauth2/default';
    const scopes = 'openid';
    ...
    if (this.platform.is('cordova')) {
      this.authConfig = {
        ...
        redirect_url: 'com.okta.dev-602142:/callback',
        scopes: scopes,
        usePkce: true,
        end_session_redirect_url: 'com.okta.dev-602142:/logout',
      };
    } else {
      this.authConfig = {
        identity_client: clientId,
        ...
        usePkce: true,
        response_type: 'code',
        end_session_redirect_url: 'http://localhost:8100/logout',
      };
    }
  }
